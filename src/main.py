...
def init():
    ...
    balls = [  
        ...
        Ball(-133,  120, 0, 0,   0/ 256.0,   0 / 256.0,   0 / 256.0, 10),
        Ball( -87,  120, 0, 0, 137/ 256.0,  15 / 256.0, 101 / 256.0, 10),
        Ball(-123,  140, 0, 0,   0/ 256.0, 256 / 256.0,   0 / 256.0, 10),
        Ball( -97,  140, 0, 0, 255/ 256.0, 183 / 256.0,  76 / 256.0, 10),
        Ball(-110,  160, 0, 0, 229/ 256.0,   0 / 256.0,  30 / 256.0, 10),                
    ]
    reward = 0
